...
class CartResource(Resource):
    ...
    def get(self, id):
        ...
        qryFirst = Carts.query.filter_by(user_id=id).first()
        if qryFirst is not None:
            rows = []
            for row in qry.all():
