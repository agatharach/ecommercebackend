...
class UserResource(Resource):
    ...
    def post(self):
        ...
        user = Users(data['username'], data['password'], data['alamat'],
                     data['status'], data['nomorhp'])
        db.session.add(user)
        db.session.commit()
...
class CreateTokenResource(Resource):
    ...
    def get(self):
        ...
        qry = Users.query
        userData = qry.filter_by(username=data['username']).filter_by(
...
api.add_resource(UserGetResource, '/whoisme', '/whoisme/<id>')
